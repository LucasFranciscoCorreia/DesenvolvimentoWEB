  ...
  <div id="app">
    <nav class="navbar navbar-expand-lg navbar-light mr-auto">
      <div class="collapse navbar-collapse ml-auto" id="navbarNav">
        ...
        <div v-else-if="!isLogged && (tab == 'Serviço' || tab=='Produtos')">
          <li 
          v-if="tab=='Serviço'"
          :key='ServicoNLogado'
          @click="selected='ServicoNLogado'"
          :class="['nav-item',{active: selected == 'ServicoNLogado'}]"
          >
          <a :class="['nav-link',{disabled: selected=='ServicoNLogado'}]">{{tab}}</a>
        </li>
        <li 
        v-if="tab=='Produtos'"
        :key='ProdutoNLogado'
        @click="selected='ProdutoNLogado'"
        :class="['nav-item',{active: selected == 'ProdutoNLogado'}]"
        >
        <a :class="['nav-link',{disabled: selected=='ProdutoNLogado'}]">{{tab}}</a>
      </li>
